...
export const useUIStore = create((set) => ({
  ...
  activeCity: (() => { try { return typeof window !== "undefined" ? localStorage : { getItem: () => null, setItem: () => {} }.getItem("cg_city_slug") || ""; } catch { return ""; } })(),
  setActiveCity: (activeCity) => {
    if (activeCity) {
      typeof window !== "undefined" ? localStorage : { getItem: () => null, setItem: () => {} }.setItem("cg_city_slug", activeCity);
    }
    set({ activeCity });
  },
  ...
  lang: (() => {
    try {
      const saved = typeof window !== "undefined" ? localStorage : { getItem: () => null, setItem: () => {} }.getItem("cg_lang");
  ...
  setLang: (lang) => {
    try { typeof window !== "undefined" ? localStorage : { getItem: () => null, setItem: () => {} }.setItem("cg_lang", lang); } catch (e) { console.error(e); }
    set({ lang });
  },
